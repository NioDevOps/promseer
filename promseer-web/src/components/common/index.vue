        ...
        <i-col :span="spanLeft" class="layout-menu-left">
            <Menu :active-name="setActive" theme="dark" width="auto" @on-select="routeTo">
                <div class="layout-logo-left">
                    <h3>Promseer后台管理</h3></div>
                <Menu-item name="registerMetric">
                    <Icon type="ios-navigate" :size="iconSize"></Icon>
                    <span class="layout-text">监听metric</span>
                </Menu-item>
                <Menu-item name="predictTarget">
                    <Icon type="ios-navigate" :size="iconSize"></Icon>
                    <span class="layout-text">预测target</span>
                </Menu-item>
            </Menu>
        </i-col>
